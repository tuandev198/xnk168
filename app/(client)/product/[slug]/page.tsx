...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${product?.name || "Sản phẩm"} | Công Ty Xuất Nhập Khẩu 628`,
    description:
      typeof product?.description === "string"
        ? product.description
        : "Chi tiết sản phẩm tại Công Ty Xuất Nhập Khẩu 628",
    keywords: [product?.name, "nông sản", "xuất khẩu", "Công Ty Xuất Nhập Khẩu 628"],
    openGraph: {
      title: product?.name,
      description:
        typeof product?.description === "string"
      ...
      images: [
        {
          url: product?.imageUrl || "/fallback.jpg",
          width: 1200,
          height: 630,
    ...
    <Container className="flex flex-col md:flex-row gap-10 py-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        ...
        <div className="flex items-center gap-2.5 lg:gap-3">
          {/* TODO: Thêm nút giỏ hàng và yêu thích */}
